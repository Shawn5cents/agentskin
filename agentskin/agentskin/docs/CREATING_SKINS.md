...
This is where we created the **Aliases**. On Sylectus, "Pickup City" became `origin`. On the Weather API, we do the same thing to make it clean and deterministic.
...
## 📊 Phase 5: Token Savings (The Value)
